...
public class MaterialTab implements View.OnTouchListener {
	...
	public MaterialTab(Context ctx,boolean hasIcon) {
        ...
        normal = RobotoTypefaceManager.obtainTypeface(
                ctx,
                RobotoTypefaceManager.Typeface.ROBOTO_CONDENSED_REGULAR);
        bold = RobotoTypefaceManager.obtainTypeface(
                ctx,
	...
	public void disableTab() {
		...
		if(text != null){
            ...
            RobotoTextViewUtils.setTypeface(this.text, normal);
        }
	...
	public void activateTab() {
		...
		if(text != null) {
            ...
            RobotoTextViewUtils.setTypeface(this.text, bold);
        }
